...
class MessageGroupingWithTimeStamp extends StatefulWidget {
   MessageGroupingWithTimeStamp( {Key? key,
    required this.name,
    required this.email,
    this.receiverId,
    required this.image})
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Positioned(
                                          bottom: 0,
                                          right: 0,
                                          child: Text(messageTime(messagesList[index].timeStamp.toString()).toString() ,textAlign: TextAlign.left, style: const TextStyle(fontSize: 10),))
                                    ],
                                  ),
                                ),
                              ),
